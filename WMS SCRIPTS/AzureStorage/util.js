 ...
 */
define(['underscore', '../AzureStorage/constants.js'],
/**
 * Module params:
 */
function (_, Constants) {
  ...
  */
  azureutil.trimPortFromUri = function (uri) {
  ...
  */
  azureutil.objectKeysLength = function (value) {
    if (!value) {
      return 0;
    }
  ...
  */
  azureutil.is32 = function () {
    return !azureutil.isBrowser() && process.arch === 'ia32';
  };
  ...
  */
  azureutil.objectIsEmpty = function (object) {
  ...
  */
  azureutil.objectIsInt = function (value) {
  ...
  */
  azureutil.objectIsNaN = function (value) {
  ...
  */
  azureutil.objectIsString = function (object) {
  ...
  */
  azureutil.objectIsFunction = function (object) {
  ...
  */
  azureutil.zeroPaddingString = function(str, len) {
    var paddingStr = '0000000000' + str;
    if(paddingStr.length < len) {
      return azureutil.zeroPaddingString(paddingStr, len);
    } else {
  ...
  */
  azureutil.IsNullOrEmptyOrUndefinedOrWhiteSpace = function (value) {
  ...
  * @return {string}
  */
  azureutil.stringFormat = function (text) {
  ...
  */
  azureutil.stringStartsWith = function (text, prefix) {
    if (_.isNull(prefix)) {
      return true;
    }
  ...
  */
  azureutil.stringEndsWith = function (text, suffix) {
    if (_.isNull(suffix)) {
      return true;
    }
  ...
  */
  azureutil.removeBOM = function (str) {
  ...
  * @return {boolean}
  */
  azureutil.inArrayInsensitive = function (needle, haystack) {
  ...
  * @return mix
  */
  azureutil.tryGetValueInsensitive = function (key, haystack, defaultValue) {
    if (haystack) {
  ...
  * @return mix
  */
  azureutil.tryGetValueChain = function (object, keys, defaultValue) {
    if (keys.length === 0) {
      return object;
    }
    ...
    if (object && object[currentKey] !== undefined) {
      return azureutil.tryGetValueChain(object[currentKey], keys, defaultValue);
    }
  ...
  */
  azureutil.setObjectInnerPropertyValue = function(object, propertyChainKeys, value){
    ...
    azureutil.setObjectInnerPropertyValue(object[currentKey], propertyChainKeys, value);
  };
  ...
  */
  ...
  azureutil.normalizeArgs = function (optionsOrCallback, callback, result) {
    var options = {};
  ...
  azureutil.getNodeVersion = function () {
  ...
  * @ignore
  */
  azureutil.calculateMD5 = function(readStream, bufferLength, options, callback) {
  ...
  */
  azureutil.isBufferAllZero = function (buffer) {
  ...
  */
  var zeroBuffer = null;
  azureutil.writeZerosToStream = function (stream, length, md5Hash, progressCallback, callback) {
    ...
    return stream.write(buffer, function () {
      if (azureutil.objectIsFunction(progressCallback)) {
        progressCallback(null, buffer.length);
      }
      buffer = null;
      if (remaining > 0) {
        azureutil.writeZerosToStream(stream, remaining, md5Hash, progressCallback, callback);
      } else if (azureutil.objectIsFunction(callback)) {
        callback(null, null);
      }
    });
  };
  ...
  */
  azureutil.getContentMd5 = function (content, encoding) {
  ...
  azureutil.getNextLocation = function(lastLocation, locationMode) {
    switch(locationMode) {
  ...
  azureutil.getNextListingLocationMode = function (token) {
  ...
  azureutil.isStreamPaused = function (object) {
  ...
  */
  azureutil.parseCopyProgress = function (progress) {
  ...
  */
  azureutil.normalizePropertyNameFromXML = function (propertyName) {
  ...
  */
  azureutil.setPropertyValueFromXML = function (result, xmlNode, toNormalize) {
    for (var subPropertyName in xmlNode) {
      if (xmlNode.hasOwnProperty(subPropertyName)) {
        if (toNormalize) {
          ...
          azureutil.setObjectInnerPropertyValue(result, propertyChain, xmlNode[subPropertyName]);
        } else {
        ...
        if (subPropertyName.toLowerCase() === 'copyprogress') {
          ...
          azureutil.setObjectInnerPropertyValue(result, ['copy', 'bytesCopied'], parseInt(info.bytesCopied));
          azureutil.setObjectInnerPropertyValue(result, ['copy', 'totalBytes'], parseInt(info.totalBytes));
        }
      }
    }
  };
   ...
   */
  azureutil.filterOutNonReservedProperties = function (reserved, options) {
