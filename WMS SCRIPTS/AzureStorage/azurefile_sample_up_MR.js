 ...
 */
define(['N/file', 'N/record', 'N/search', 'N/xml', '../Libraries/global_modules.js', '../Libraries/xml_module.js', './azure-storage.file.js'],
/**
  * Module params:
  * @param {file} file
  * @param {record} record
...
function(file, record, search, xml, global_modules, xml_module, AzureStorage) {
    ...
    */
    function map(context) {
        ...
        //processXML_toNS(fileName, fileText);
    ...
    */
    ...
    function processXML_toNS(fileName, fileText) {
