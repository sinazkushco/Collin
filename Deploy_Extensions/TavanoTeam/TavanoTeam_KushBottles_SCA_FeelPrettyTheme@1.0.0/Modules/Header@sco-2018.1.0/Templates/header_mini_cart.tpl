	 ...
	 {{#if showLines}} 
		...
		<div class="header-mini-cart-buttons">
			...
			<div class="header-mini-cart-buttons-right">
				<a href="#" class="header-mini-cart-button-checkout {{#unless isMinimumOrderAmountMet}}checkout-button-disabled{{/unless}} {{#if preventCheckout}}checkout-button-disabled{{/if}}" data-touchpoint="checkout" data-hashtag="#" >
					{{translate 'Checkout'}}
				</a>
			</div>
		</div>
		...
		{{#unless isMinimumOrderAmountMet}}
			<p class="header-mini-cart-min-order-amount-message">{{minimumOrderAmountMessage}}</p>
		{{/unless}}
		{{#if preventCheckout}}
			<p class="header-mini-cart-min-order-amount-message">{{{preventCheckoutMessage}}}</p>
		{{/if}}
