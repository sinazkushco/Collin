...
<ul class="header-menu-myaccount">
	...
	{{#if isProductListsEnabled}}
		<li class="header-menu-myaccount-item-level2">
			<p class="header-menu-myaccount-anchor-level2" href="#" data-touchpoint="customercenter" data-hashtag="#wishlist" name="wishlist">
				{{translate 'Wishlist'}}
			</p>
	...
	<!-- Billing -->
	<li class="header-menu-myaccount-item-level2">
		<p class="header-menu-myaccount-anchor-level2" href="#" data-action="push-menu" name="billing">
			{{translate 'Billing'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</p>
		<ul class="header-menu-myaccount-level3">
	...
	<!-- Settings -->
	<li class="header-menu-myaccount-item-level2">
		<p class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="settings">
			{{translate 'Settings'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</p>
		<ul class="header-menu-myaccount-level3">
	...
	<li class="header-menu-myaccount-item-level2" data-permissions="lists.listCase.2">
		<p  class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="cases">
			{{translate 'Cases'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</p>
		<ul class="header-menu-myaccount-level3">
	...
	<li class="header-menu-myaccount-item-level2">
		<a tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#privateitems#/privateitems" name="privateitems">{{translate 'Private Items'}}</a>
		
		{{!-- <a tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#overview#/privateitems" name="privateitems">{{translate 'Private Items'}}</a> --}}
	</li>
