<div class="product-details-full">
	...
	<article class="product-details-full-content" itemscope itemtype="https://schema.org/Product">
			...
			<div class="product-details-full-main">
				{{#if isItemProperlyConfigured}}
					<form id="product-details-full-form" data-action="submit-form" method="POST">
						...
						{{!-- remove free shipping copy at request of sales dept. --}}
					<!--	
						{{#unless isPrivate}}
						{{#unless isHazmat}}
							<div class="free_shipping">
								<p>This item qualifies for <span>Free Shipping</span> on orders over $200 within the continental U.S.</p>
							</div>
						{{/unless}}
						{{/unless}}
					-->
                        <div data-view="ProductDetails.Locations.Info"></div>
		...
		<section data-view="AdditionalInformation"></section>
		...
		{{!-- Remove reviews from PDP at request of company directors.  To be evauluated at later time --}}
