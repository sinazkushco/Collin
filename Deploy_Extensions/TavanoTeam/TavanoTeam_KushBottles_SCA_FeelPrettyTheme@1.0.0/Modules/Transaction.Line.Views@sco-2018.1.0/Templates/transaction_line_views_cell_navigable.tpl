<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}}" data-item-type="{{itemType}}">
	...
	{{#if model.tariff_impact}}
	<td class="transaction-line-views-cell-navigable-item-quantity">
		<p>
			<span class="transaction-line-views-cell-navigable-item-quantity-label">{{translate 'Chinese Import Duty:'}} </span>
			<span class="transaction-line-views-cell-navigable-item-quantity-value">{{model.tariff_impact_formatted}}</span>
		</p>
	</td>
	{{/if}}
