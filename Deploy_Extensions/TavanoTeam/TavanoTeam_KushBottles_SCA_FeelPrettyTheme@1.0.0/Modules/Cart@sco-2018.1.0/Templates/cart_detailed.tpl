<div class="cart-detailed">
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
			...
			<div class="cart-summary-shipping-update_mobile">
            	<p class='cart-summary-shipping-update-text_mobile'>Our order and shipping policies have changed. Learn more <a href="/shipping-returns" target="_blank">here</a>.</p>
        	</div>
			</div>
