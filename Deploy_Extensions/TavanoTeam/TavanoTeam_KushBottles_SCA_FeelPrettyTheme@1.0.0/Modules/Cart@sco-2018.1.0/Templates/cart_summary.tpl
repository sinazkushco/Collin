...
<div class="cart-summary">
	<div class="cart-summary-container">
		...
		<div data-view="CartTariffListView"></div>
		<div data-view="CartSurchargeListView"></div>
		...
		<div class="cart-summary-shipping-cost-applied">
			...
			<p class="cart-summary-grid-float">
							<span class="cart-summary-amount-shipping">
								{{summary.estimatedshipping_formatted}}
							</span>
				{{translate 'Shipping'}}
			</p>
	...
	{{#if showActions}}
	{{#if preventCheckout}}
	<p class="cart-summary-min-order-amount-message">{{{preventCheckoutMessage}}}</p>
	{{/if}}

	{{#unless isMinimumOrderAmountMet}}
	<p class="cart-summary-min-order-amount-message">{{minimumOrderAmountMessage}}</p>
	{{/unless}}

	<div class="cart-summary-button-container">
		<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}} {{#unless isMinimumOrderAmountMet}}checkout-button-disabled{{/unless}} {{#if preventCheckout}}checkout-button-disabled{{/if}}" href="#" data-touchpoint="checkout" data-hashtag="#">
			{{translate 'Proceed to Checkout'}}
		</a>

		{{#if showPaypalButton}}
		<div class="cart-summary-btn-paypal-express {{#unless isMinimumOrderAmountMet}}checkout-button-disabled{{/unless}}">
	...
	<div class="cart-summary-shipping-update">
            <p class='cart-summary-shipping-update-text'>Our order and shipping policies have changed. Learn more <a href="/shipping-returns" target="_blank">here</a>.</p>
        </div>
	{{/if}}
</div>
