...
<div class="cart-item-summary-item-list-actionable-amount">
	<span class="cart-item-summary-item-list-actionable-amount-label">{{translate tariffLabel}}:</span>
	<span class="cart-item-summary-amount-value">{{ tariffImpact }}</span>
</div>
{{/if}}
<div class="cart-item-summary-item-list-actionable-amount">
...
<div data-view="TariffList" class="cart-item-summary-promocodes"></div>
