		...
		<div class="order-wizard-cart-summary-subtotal">
			<p class="order-wizard-cart-summary-grid-float">
				...
				<span class="order-wizard-cart-summary-subtotal-label">
					...
					{{/if}}
					<p class="order-wizard-cart-summary-subtotal-legend">{{translate 'Subtotal does not include shipping, tax, or credit fee'}}</p>
					{{#if tariff}}
						<p class="order-wizard-cart-summary-subtotal-legend">{{translate 'Subtotal includes tariff total'}}</p>
					{{/if}}
				</span>
			</p>
		</div>
		...
		{{#if surcharge}}
			<div class="order-wizard-cart-summary-discount-applied">
				<p class="order-wizard-cart-summary-grid-float">
					...
					{{translate 'Credit Fee'}}
				</p>
			</div>
		{{/if}}
		{{#if showDiscount}}
			{{#if model.summary.discounttotal}}
				<div class="order-wizard-cart-summary-discount-applied">
					<p class="order-wizard-cart-summary-grid-float">
						<span class="order-wizard-cart-summary-discount-total">
