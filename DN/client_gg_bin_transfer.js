...
function runClientscript() {
    ...
    function fieldChanged(context) {
        if (context.fieldId == "custpage_bin_location" || context.fieldId == "custpage_include_tomorrow" || context.fieldId == "custpage_start_date" || context.fieldId == "custpage_ship_type") {
            ...
            var shipTypeField = context.currentRecord.getValue("custpage_ship_type");
            var suiteletUrl = "https://system.na2.netsuite.com/app/site/hosting/scriptlet.nl?script=797&deploy=1";
            ...
            if(shipTypeField) {
                suiteletUrl += "&shiptype=" + shipTypeField;
            }
